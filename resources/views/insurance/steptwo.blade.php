                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="application_no" placeholder="Enter the Application Number" aria-label="Staff Name" value="@if(isset($insurance)){{ $insurance->application_no }}@endif">
                                </div>
                                <div class="form-group col-md-6">
         ...
         $('#step_two').validate({ 
            ...
            rules: {
             ...
             messages: {
                ...
                application_no: "Application Number is required",
